...
No hands, no people. Photorealistic. 4K.`,
  ...
  },
  {
    ...
    categoryBackgroundPrompts: {
      "belleza-cosmetica":
        `You are a background image generation expert for premium skincare and beauty advertising.

TASK: Generate a full-bleed macro photography background. 
Analyze the product being advertised, then:
1. AUTO-SELECT the COLOR PALETTE from the PRODUCT SYSTEM
2. AUTO-SELECT the MOOD VARIANT from the AMBIENT SYSTEM
3. Combine both to generate the final scene

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
STEP 1 — PRODUCT COLOR SYSTEM
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
All palettes are MUTED & MOODY — desaturated, dusty, never pure bright colors.
Think: foggy, chalky, slightly dim versions of each hue.

IF Vitamin C / Niacinamide / Brightening / Glow:
  BASE: dusty amber + warm ash ivory
  ACCENT: faded turmeric, muted gold
  TEXTURE: vitamin serum strokes — slightly viscous, semi-transparent
  MICRO: suspended micro-spheres, barely visible
  SHIMMER: dull warm bronze shimmer, one stroke only

IF Hyaluronic Acid / Hydration / Gel / Cooling:
  BASE: dusty slate blue + muted steel grey
  ACCENT: fog white, ash mint
  TEXTURE: gel strokes — flat, fluid, glassy
  MICRO: micro-bubble texture, chilled and subtle
  SHIMMER: cold silver-blue shimmer, one stroke only

IF Collagen / Rose / Lifting / Firming:
  BASE: dusty mauve + muted blush
  ACCENT: faded rose, warm grey-pink
  TEXTURE: cream strokes — smooth, semi-opaque, satin finish
  MICRO: faint rose petal vein texture beneath
  SHIMMER: muted rose-gold shimmer, one stroke only

IF Retinol / Peptides / Anti-age / Repair:
  BASE: deep warm taupe + muted ecru
  ACCENT: faded champagne, ash gold
  TEXTURE: serum strokes — ultra-thin, silk-like
  MICRO: fine protein thread texture beneath
  SHIMMER: antique gold shimmer, one stroke only

IF SPF / Sunscreen / Solar:
  BASE: muted sand + warm greige
  ACCENT: faded cream, dusty off-white
  TEXTURE: fluid sunscreen strokes — very thin, watery
  MICRO: ultra-fine sand grain on matte background
  SHIMMER: soft diffused white-gold shimmer, one stroke only

IF AHA / BHA / Exfoliant / Acids:
  BASE: cool ash grey + muted clay
  ACCENT: faded ivory, dusty stone
  TEXTURE: exfoliant serum strokes — crystalline, precise
  MICRO: fine mineral particle texture beneath
  SHIMMER: silver-frost shimmer, one stroke only

IF CBD / Botanical / Natural / Organic / Herbal:
  BASE: dusty sage + muted moss
  ACCENT: faded olive, warm linen grey
  TEXTURE: botanical oil strokes — organic, irregular edges
  MICRO: dried botanical fiber texture beneath
  SHIMMER: muted olive-bronze shimmer, one stroke only

IF Supplements / Wellness / Vitamins / Nutrition:
  BASE: warm dusty terracotta + muted clay
  ACCENT: faded rust, ash ochre
  TEXTURE: dense serum strokes — rich, slightly opaque
  MICRO: fine mineral dust texture beneath
  SHIMMER: copper-bronze shimmer, one stroke only

IF Makeup / Foundation / Color cosmetics:
  BASE: deep dusty plum + muted grey-violet
  ACCENT: faded burgundy, ash lavender
  TEXTURE: pigment strokes — velvety, semi-matte finish
  MICRO: fine silk powder texture beneath
  SHIMMER: deep violet-bronze shimmer, one stroke only

IF Eye / Caffeine / Depuff / Dark circles:
  BASE: dusty lavender + cool slate grey
  ACCENT: faded lilac, muted icy blue
  TEXTURE: ultra-light eye serum strokes — extremely thin
  MICRO: fine silk micro-weave texture
  SHIMMER: soft silver-violet shimmer, one stroke only

DEFAULT (no match):
  BASE: warm slate grey + muted ash white
  ACCENT: dusty pearl, faded ivory
  TEXTURE: clean serum strokes — minimal, elegant
  MICRO: barely visible linen grain
  SHIMMER: soft silver shimmer, one stroke only

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
STEP 2 — AMBIENT MOOD SYSTEM
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Select the ambient that best matches the product's brand positioning or campaign tone.
If unclear, select LUJOSO as default.

AMBIENT: SPA
  LIGHTING: very soft diffused light, no hard shadows, almost no directionality —
  like light filtered through rice paper or frosted glass. Calm, still, breathable.
  SURFACE FEEL: slightly damp matte surface, like stone or wet ceramic.
  Add a micro water-droplet condensation texture on the matte background — 
  extremely subtle, barely perceptible.
  ATMOSPHERE: silent, therapeutic, premium wellness clinic.
  EXTRA: slightly cooler overall tone. Desaturate the palette 10% extra.

AMBIENT: LABORATORIO
  LIGHTING: single strong directional soft-box from upper-left at 45°, 
  clean and clinical. High contrast between lit and shadow zones.
  SURFACE FEEL: clean matte surface — like frosted glass or polished stone.
  Ultra-precise stroke edges. Strokes feel measured, intentional, scientific.
  ATMOSPHERE: clinical precision, dermatological authority, research-grade.
  EXTRA: slightly cooler and more neutral. Reduce warmth of palette 15%.
  Add a very faint fine grid micro-texture to the matte background 
  (like lab paper) — almost invisible.

AMBIENT: OUTDOOR
  LIGHTING: soft natural diffused daylight — overcast sky quality.
  No hard shadows. Light comes from above with gentle wrap-around fill.
  SURFACE FEEL: slightly organic, natural — like stone or aged concrete outdoors.
  Strokes feel fluid and free, slightly irregular organic edges.
  ATMOSPHERE: fresh air, slow living, clean beauty, nature-grounded.
  EXTRA: slightly warmer and earthier. Subtle environmental texture on background —
  like fine dust particles or natural grain. Not clean studio.

AMBIENT: LUJOSO
  LIGHTING: dramatic soft-box from upper-left, strong specular highlights
  on the gel strokes. Deep contrast zones. Moody and cinematic.
  SURFACE FEEL: ultra-smooth matte surface — like brushed velvet or matte marble.
  Strokes are thick, confident, editorial. Premium tension.
  ATMOSPHERE: high-end editorial, fashion week backstage, luxury department store.
  EXTRA: richest version of the selected palette. Deep shadows in corners
  (very subtle vignette feel). One stroke has a more pronounced shimmer.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
STEP 3 — FINAL IMAGE GENERATION
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Using the auto-selected COLOR PALETTE + AMBIENT MOOD, generate:

Extreme close-up macro photography of [TEXTURE] on a soft matte surface in 
[BASE] and [ACCENT] — all tones muted, dusty and desaturated, never bright 
or saturated. Exactly 2–3 broad sweeping diagonal strokes across the frame — 
thin, flat and fluid, semi-transparent with a restrained gloss sheen 
(not overly shiny). [MICRO] texture subtly visible beneath. Wide open breathing 
space between strokes — large areas of matte background visible, slightly dim 
and atmospheric. One stroke catches [SHIMMER] — subtle, not flashy.

[AMBIENT LIGHTING INSTRUCTIONS]
[AMBIENT SURFACE FEEL]
[AMBIENT ATMOSPHERE]
[AMBIENT EXTRA]

Muted & moody color grade overall — slightly underexposed feel, 
chalky and intimate. Full-bleed composition, no cropping.
Ultra high resolution photorealistic macro photography, 4K, 
premium beauty brand editorial.
No text, no people, no products, no logos, no hands.`,
      "fitness-deporte":
