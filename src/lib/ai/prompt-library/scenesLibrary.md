...
## Tecnología
*Dispositivos, gadgets, wearables, accesorios tech, apps*

---

### Ángulo profesional — productividad elevada
A focused professional in their early 30s at a clean modern desk in a bright home office. Monitor visible and blurred, tech product held prominently at right hand. They look at it with appreciation, one hand hovering mid-use. Organized desk: notebook, designer lamp, ceramic coffee mug. Natural side window light creates clean directional shadows. Sophistication and efficiency. Cool neutral tones — white, charcoal, silver, warm wood accents. Shot at 40mm, commercial editorial. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.

---

### Ángulo lifestyle — integración natural
A relaxed person in their 30s lounges on a mid-century modern sofa, afternoon golden light through large windows. Tech product held casually — using it naturally, not presenting. A dog or cat sits nearby. Throw pillows, knit blanket, books on coffee table. Comfortable smile — someone in their element. Warm tones — amber, caramel, soft neutrals — contrasting with clean tech lines. Shot at 50mm, editorial lifestyle, bokeh. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.

---

### Ángulo innovación — el futuro llegó
A curious person in their late 20s stands in a sleek minimalist space — showroom or modern loft. Clean white or concrete walls, one dramatic spotlight from above creating a pool of light. They hold the product at eye level, examining with visible fascination, head tilted. Space intentionally empty — product is the only object. Minimal architectural outfit in black or dark navy. Editorial, almost gallery-like. High contrast — deep shadows, single light source, monochromatic. Shot at 50mm, dramatic lighting. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.

---

### Ángulo gaming / entretenimiento — inmersión total
A young person in their 20s sits in a dimly lit room, face illuminated by a screen's glow. They wear wireless headphones around their neck, holding the tech product naturally. The setup shows a monitor with colorful content (blurred), a mechanical keyboard, ambient RGB lighting in the background — teal and purple. Their expression is engaged, immersed, slightly smiling. Comfortable hoodie, relaxed posture leaning back. Cool moody tones — deep blue, teal, purple accents, with warm skin tones from screen light. Shot at 35mm, available-light cinematic. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.

---

### Ángulo problema — tecnología obsoleta
A frustrated person stands at a cluttered desk, old tangled cables, a slow laptop with spinning wheel icon (blurred on screen), sticky notes everywhere. They hold the new sleek product in contrast — holding it next to the old mess. One hand on their forehead, half exasperated half relieved to have found the solution. The visual contrast between old chaos and new minimal product is stark. Flat overhead office lighting, slightly cool and clinical. Desaturated except for the product itself which feels crisp and modern. Shot at 35mm, commercial narrative. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.

---

### Ángulo movilidad — siempre conectado *(nuevo)*
A person in their early 30s walks briskly through a busy modern train station or airport, product in hand and in active use — earbuds, device, or wearable clearly visible. Commuter bag over shoulder, professional but casual. The crowd around them is blurred motion, but they move with calm certainty — the product gives them an edge. Bright terminal lighting, architectural lines. Cool urban tones — charcoal, steel, with warm skin contrast. Shot at 35mm, motion blur on background, sharp on subject. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.

---

### Ángulo regalo — la elección correcta *(nuevo)*
A person in their 40s sits at a kitchen table, holding the tech product in its box with visible satisfaction — they just decided. A laptop is open beside them showing a product page (blurred). They look at the box with a quiet smile, phone in other hand as if about to tell someone. Holiday or birthday wrapping paper nearby. The scene communicates confident choice. Warm domestic tones — cream, warm wood, soft afternoon light. Shot at 50mm, shallow depth of field, lifestyle editorial. Subject and product on right side only. Left half must remain completely clean for pre-rendered text.
